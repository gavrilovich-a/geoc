...
<html dir="rtl" lang="he-IL">
	<head>
		...
		<title>GEO - departament service</title>
		...
		<link rel="stylesheet" href="css/department-service.css">
	    ...
	    <div class="col-md-12">
	        <div class="dimox_breadcrumbs">
	            <div class="breadcrumbs">
                    ...
                    <span class="sep">|</span>
	                <span class="current">איכות השירות וחווית הלקוח</span>
	            </div>
	        </div>
	    </div>
	</section>
...
איכות השירות וחווית הלקוח            </h2>
            ...
            <div class = "adv-text-block-description">
                <p>
                    גיאוקרטוגרפיה מובילה את תחום איכות השירות ומעמידה לרשות לקוחותיה צוות מומחים, בעלי ניסיון מגוון ורב שנים, וכלים מעשיים למדידה ושיפור השירות, מתוך מטרה להביא לגידול בפעילות העסקית.
               </p>

                <p>
                    החברה מבצעת מחקרי אד-הוק ומחקרים רציפים לליווי הארגון, בכל נקודות המגע שלו – פנימה והחוצה – במדידה, ניתוח, ניטור ודיווח של תהליכי מכירה, שירות, שירות פנימי וממשקים פנימיים.
                </p>

                <p>
                    הפעילות כוללת מחקרי שביעות רצון לקוחות, שביעות רצון עובדים, מחקרים לבחינת הקשר עם ספקים וסוכנים, וכן בקרות לקוח סמוי ותצפיות, למדידה והערכה של תהליכי עבודה והטמעת נהלי הארגון.
                </p>

                <p>
                    הפעילות נערכת באמצעות מגוון שיטות וכלי איסוף, בהתאמה למטרות המחקר: סקרים טלפוניים, סקרים אינטרנטיים, סקרי SMS, QR-CODE, ראיונות פנים אל פנים בנקודת המכירה, לקוח סמוי, לקוח מתלווה, תצפיות ועוד.
                </p>
