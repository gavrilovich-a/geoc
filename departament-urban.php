...
<html dir="rtl" lang="he-IL">
	<head>
		...
		<title>GEO - departament urban</title>
		...
		<link rel="stylesheet" href="css/departament-urban.css">
	    ...
	    <div class = "row">
	        ...
	        <div class="dimox_breadcrumbs">
	            <div class="breadcrumbs">
                    ...
                    <span class="sep">|</span>
	                <span class="current">תכנון אורבאני</span>
	            </div>
	        </div>
	    </div>
        </div>
...
<div class = "col-md-12">
            ...
            <div class = "adv-text-block-description">
                <p>
המחלקה לתכנון אורבני מלווה רשויות מקומיות, משרדי ממשלה , גופי תכנון ויזמים פרטיים בהליכי תכנון החל מרמה מפורטת של בניין, ועד לשכונה, אזור, וערים במסגרת תכניות מתאר כוללניות, תכניות עירוניות סטטוטוריות ואסטרטגיות ומחקרים ברמה הארצית.                 </p>

                <p>
הצוות המקצועי כולל אנשי מקצוע מובילים: מתכנני ערים, כלכלנים, מוסמכים במנהל עסקים, שמאים ועורכי דין                </p>
