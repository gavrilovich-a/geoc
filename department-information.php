...
<html dir="rtl" lang="he-IL">
	<head>
		...
		<link rel="stylesheet" href="css/department-information.css">
...
<div class = "fix-header">
	    ...
	    <div class = "row">
	        ...
	        <div class="dimox_breadcrumbs">
	            <div class="breadcrumbs">
                    ...
                    <span class="sep">|</span>
	                <span class="current">מודלים ופתרונות עתירי מידע</span>
	            </div>
	        </div>
	    </div>
        </div>
    ...
    <section class = "container adv-text-block">
        <div class = "row">
            <div class = "col-md-12">
            <h2 class = "adv-title">
מודלים ופתרונות עתירי מידע            </h2>

            <div class = "adv-text-block-description">
                <p>
מערכות המידע של גיאוקרטוגרפיה, אינן רק דרג משרת טכני בלבד בקבוצת גיאוקרטוגרפיה, אלא הן ענף כלכלי נפרד, העוסק במחקר ופיתוח של מוצרים ייחודיים בתחום מערכות המידע ושל מודלים ופתרונות עתירי מידע.                </p>

                <p>
לקוחות "גיאוקרטוגרפיה" נהנים מתשתית רחבה של מערכת מידע, מחשוב וטכניקות מחקריות, שפותחו בחברה:                </p>
